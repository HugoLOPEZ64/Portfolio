      ...
      <div className="container about__container">
        ...
        <div className="about__content">
          <div className="about__cards">
            ...
            <p>
              After being lucky enough to be able to experiment different careers around the world for the past 10 years, I have decided in 2021 to reconnect with my teenage years by studying web development. 
              ...
              Always keen on exploring new exciting work opportunities.
